...
module.exports = class Transactions1697006086810 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "user_transaction" ("id" int NOT NULL IDENTITY(1,1), "created" datetime2 NOT NULL CONSTRAINT "DF_1019086e384f799f2bdbe3f6085" DEFAULT getdate(), "updated" datetime2 NOT NULL CONSTRAINT "DF_cdd9335d11e2e19c02b5c5fa397" DEFAULT getdate(), "type" nvarchar(255) NOT NULL, "amount" float NOT NULL, "fee" float NOT NULL CONSTRAINT "DF_7be69ef7332f2d6ad05b8e70a06" DEFAULT 0, "balance" float, "creationTimestamp" datetime2 NOT NULL, "expiresTimestamp" datetime2, "tag" nvarchar(255), "lightningWalletId" int, "lightningTransactionId" int NOT NULL, CONSTRAINT "PK_e36b77a5263ac0f191277c4c5d2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "transaction_lightning" ("id" int NOT NULL IDENTITY(1,1), "created" datetime2 NOT NULL CONSTRAINT "DF_3ba7baa12ab2299212be619da72" DEFAULT getdate(), "updated" datetime2 NOT NULL CONSTRAINT "DF_7250c44e737cdc826f69ea92eb5" DEFAULT getdate(), "type" nvarchar(255) NOT NULL, "state" nvarchar(255) NOT NULL, "transaction" nvarchar(255) NOT NULL, "secret" nvarchar(255) NOT NULL, "publicKey" nvarchar(255), "amount" float NOT NULL, "fee" float NOT NULL CONSTRAINT "DF_30767c0861424ab2245c94eb40a" DEFAULT 0, "balance" float, "creationTimestamp" datetime2 NOT NULL, "expiresTimestamp" datetime2, "confirmedTimestamp" datetime2, "description" nvarchar(MAX), "reason" nvarchar(255), "paymentRequest" nvarchar(MAX), CONSTRAINT "PK_4f9024cfed331c3c379a9b481c0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "dbo"."lightning_wallet" ADD "balance" float NOT NULL CONSTRAINT "DF_11d6f2ffc02954b3548a52b31a7" DEFAULT 0`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "dbo"."lightning_wallet" DROP CONSTRAINT "DF_11d6f2ffc02954b3548a52b31a7"`);
        await queryRunner.query(`ALTER TABLE "dbo"."lightning_wallet" DROP COLUMN "balance"`);
