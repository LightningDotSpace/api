...
async function bootstrap() {
  ...
  app.setGlobalPrefix(Config.version, { exclude: ['', '.well-known/(.*)', 'monitoring', 'monitoring/data', 'monitoring/monitoring.js', 'monitoring/btc', 'monitoring/btc.js', 'monitoring/btc/history', 'monitoring/usd', 'monitoring/usd.js', 'monitoring/usd/history'] });
